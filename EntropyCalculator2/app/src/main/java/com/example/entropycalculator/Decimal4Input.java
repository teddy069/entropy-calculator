...
public class Decimal4Input extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_decimal4_input);
    ...
    private void initiateAllElements(){
        de_4_edit1 = findViewById(R.id.de_4_edit1);
        de_4_edit2 = findViewById(R.id.de_4_edit2);
        de_4_edit3 = findViewById(R.id.de_4_edit3);
        ...
        tempError = findViewById(R.id.de_error5);
        button = findViewById(R.id.de_4_next);
    }

    private void storeAllValues() {

        try{
            a = Double.parseDouble(de_4_edit1.getText().toString());
            b = Double.parseDouble(de_4_edit2.getText().toString());
            c = Double.parseDouble(de_4_edit3.getText().toString());
            ...
            calulate();
                ...
                intent1 = new Intent(Decimal4Input.this, Display.class);
