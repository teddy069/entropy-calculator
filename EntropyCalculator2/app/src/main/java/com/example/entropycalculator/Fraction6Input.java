...
public class Fraction6Input extends AppCompatActivity {


        EditText fra_6_edit1;
        EditText fra_6_edit2;
        EditText fra_6_edit3;
        EditText fra_6_edit4;
        EditText fra_6_edit5;
        ...
        TextView fra_6_text1;
        TextView fra_6_text2;
        TextView fra_6_text3;
        TextView fra_6_text4;
        TextView fra_6_text5;
        TextView fra_6_text6;
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            setContentView(R.layout.activity_fraction6_input);
            ...
            temp = "/" + total;
            fra_6_text1.setText(temp);
            fra_6_text2.setText(temp);
            fra_6_text3.setText(temp);
            fra_6_text4.setText(temp);
            fra_6_text5.setText(temp);
        ...
        private void storeAllValues() {
            ...
            try {
                a = Integer.parseInt(fra_6_edit1.getText().toString());
                b = Integer.parseInt(fra_6_edit2.getText().toString());
                c = Integer.parseInt(fra_6_edit3.getText().toString());
                d = Integer.parseInt(fra_6_edit4.getText().toString());
                e = Integer.parseInt(fra_6_edit5.getText().toString());
        ...
        private void initiateAllElements() {
            ...
            fra_6_edit1 = findViewById(R.id.fra_6_edit1);
            fra_6_edit2 = findViewById(R.id.fra_6_edit2);
            fra_6_edit3 = findViewById(R.id.fra_6_edit3);
            fra_6_edit4 = findViewById(R.id.fra_6_edit4);
            fra_6_edit5 = findViewById(R.id.fra_6_edit5);
            fra_6_edit6 = findViewById(R.id.fra_6_edit6);
            //fra_6_edit7 = findViewById(R.id.fra_7_edit7);
            //fr6_7_edit8 = findViewById(R.id.fra_8_edit8);

            fra_6_text1 = findViewById(R.id.fra_6_text1);
            fra_6_text2 = findViewById(R.id.fra_6_text2);
            fra_6_text3 = findViewById(R.id.fra_6_text3);
            fra_6_text4 = findViewById(R.id.fra_6_text4);
            fra_6_text5 = findViewById(R.id.fra_6_text5);
            fra_6_text6 = findViewById(R.id.fra_6_text6);
            //fra_7_text7 = findViewById(R.id.fra_7_text7);
            //fra_7_text8 = findViewById(R.id.fra_8_text8);
            tempError = findViewById(R.id.tempError6);

            button = findViewById(R.id.fra_6_next);
