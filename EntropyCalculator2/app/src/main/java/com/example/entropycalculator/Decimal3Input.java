...
public class Decimal3Input extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_decimal3_input);
    ...
    private void initiateAllElements(){
        de_3_edit1 = findViewById(R.id.de_3_edit1);
        de_3_edit2 = findViewById(R.id.de_3_edit2);
        ...
        tempError = findViewById(R.id.de_error3);
        button = findViewById(R.id.de_3_next);
    }

    private void storeAllValues() {

        try{
            a = Double.parseDouble(de_3_edit1.getText().toString());
            b = Double.parseDouble(de_3_edit2.getText().toString());
