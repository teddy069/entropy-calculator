...
public class Fraction5Input extends AppCompatActivity {


    EditText fra_5_edit1;
    EditText fra_5_edit2;
    EditText fra_5_edit3;
    EditText fra_5_edit4;
    EditText fra_5_edit5;
    ...
    TextView fra_5_text1;
    TextView fra_5_text2;
    TextView fra_5_text3;
    TextView fra_5_text4;
    TextView fra_5_text5;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fraction5_input);
        ...
        temp = "/" + total;
        fra_5_text1.setText(temp);
        fra_5_text2.setText(temp);
        fra_5_text3.setText(temp);
        fra_5_text4.setText(temp);
        fra_5_text5.setText(temp);
    ...
    private void storeAllValues() {
        ...
        try {
            a = Integer.parseInt(fra_5_edit1.getText().toString());
            b = Integer.parseInt(fra_5_edit2.getText().toString());
            c = Integer.parseInt(fra_5_edit3.getText().toString());
            d = Integer.parseInt(fra_5_edit4.getText().toString());
            e = Integer.parseInt(fra_5_edit5.getText().toString());
            ...
            calulate();
            if((a+b+c+d+e)/total == 1.0) {
                intent1 = new Intent(com.example.entropycalculator.Fraction5Input.this, Display.class);
    ...
    private void initiateAllElements() {
        ...
        fra_5_edit1 = findViewById(R.id.fra_5_edit1);
        fra_5_edit2 = findViewById(R.id.fra_5_edit2);
        fra_5_edit3 = findViewById(R.id.fra_5_edit3);
        fra_5_edit4 = findViewById(R.id.fra_5_edit4);
        fra_5_edit5 = findViewById(R.id.fra_5_edit5);
        ...
        fra_5_text1 = findViewById(R.id.fra_5_text1);
        fra_5_text2 = findViewById(R.id.fra_5_text2);
        fra_5_text3 = findViewById(R.id.fra_5_text3);
        fra_5_text4 = findViewById(R.id.fra_5_text4);
        ...
        tempError = findViewById(R.id.tempError5);

        button = findViewById(R.id.fra_5_next);
