...
public class Decimal5Input extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_decimal5_input);
    ...
    private void initiateAllElements(){
        ...
        button = findViewById(R.id.de_5_next);
    }

    private void storeAllValues() {

        try{
            a = Double.parseDouble(de_5_edit1.getText().toString());
            b = Double.parseDouble(de_5_edit2.getText().toString());
            c = Double.parseDouble(de_5_edit3.getText().toString());
            d = Double.parseDouble(de_5_edit4.getText().toString());
