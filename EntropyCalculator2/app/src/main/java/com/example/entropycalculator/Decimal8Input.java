...
public class Decimal8Input extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_decimal8_input);
    ...
    private void initiateAllElements(){
            de_8_edit1 = findViewById(R.id.de_8_edit1);
            de_8_edit2 = findViewById(R.id.de_8_edit2);
            de_8_edit3 = findViewById(R.id.de_8_edit3);
            de_8_edit4 = findViewById(R.id.de_8_edit4);
            de_8_edit5 = findViewById(R.id.de_8_edit5);
            de_8_edit6 = findViewById(R.id.de_8_edit6);
            de_8_edit7 = findViewById(R.id.de_8_edit7);
            de_8_edit8 = findViewById(R.id.de_8_edit8);

            tempError = findViewById(R.id.de_error8);

            button = findViewById(R.id.de_8_next);
        }

    private void storeAllValues() {

        try{
            a = Double.parseDouble(de_8_edit1.getText().toString());
            b = Double.parseDouble(de_8_edit2.getText().toString());
            c = Double.parseDouble(de_8_edit3.getText().toString());
            d = Double.parseDouble(de_8_edit4.getText().toString());
            e = Double.parseDouble(de_8_edit5.getText().toString());
            f = Double.parseDouble(de_8_edit6.getText().toString());
            g = Double.parseDouble(de_8_edit7.getText().toString());
            h = Double.parseDouble(de_8_edit8.getText().toString());



            calulate();

            if((a+b+c+d+e+f+g+h) == 1.0) {
                intent1 = new Intent(Decimal8Input.this, Display.class);
