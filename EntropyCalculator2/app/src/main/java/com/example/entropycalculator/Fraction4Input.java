...
public class Fraction4Input extends AppCompatActivity {


    EditText fra_4_edit1;
    EditText fra_4_edit2;
    EditText fra_4_edit3;
    ...
    TextView fra_4_text1;
    TextView fra_4_text2;
    TextView fra_4_text3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fraction4_input);
        ...
        temp = "/" + total;
        fra_4_text1.setText(temp);
        fra_4_text2.setText(temp);
        fra_4_text3.setText(temp);
    ...
    private void storeAllValues() {
        ...
        try {
            a = Integer.parseInt(fra_4_edit1.getText().toString());
            b = Integer.parseInt(fra_4_edit2.getText().toString());
            c = Integer.parseInt(fra_4_edit3.getText().toString());
    ...
    private void initiateAllElements() {
        ...
        fra_4_edit1 = findViewById(R.id.fra_4_edit1);
        fra_4_edit2 = findViewById(R.id.fra_4_edit2);
        fra_4_edit3 = findViewById(R.id.fra_4_edit3);
        ...
        fra_4_text1 = findViewById(R.id.fra_4_text1);
        fra_4_text2 = findViewById(R.id.fra_4_text2);
        fra_4_text3 = findViewById(R.id.fra_4_text3);
        ...
        tempError = findViewById(R.id.tempError4);

        button = findViewById(R.id.fra_4_next);
