...
public class Fraction3Input extends AppCompatActivity {


    EditText fra_3_edit1;
    EditText fra_3_edit2;
    EditText fra_3_edit3;
    ...
    TextView fra_3_text1;
    TextView fra_3_text2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fraction3_input);
        ...
        temp = "/" + total;
        fra_3_text1.setText(temp);
        fra_3_text2.setText(temp);
    ...
    private void storeAllValues() {
        ...
        try {
            a = Integer.parseInt(fra_3_edit1.getText().toString());
            b = Integer.parseInt(fra_3_edit2.getText().toString());
            c = Integer.parseInt(fra_3_edit3.getText().toString());
            ...
            if((a+b+c)/total == 1) {
                intent1 = new Intent(com.example.entropycalculator.Fraction3Input.this, Display.class);
    ...
    private void initiateAllElements() {
        ...
        fra_3_edit1 = findViewById(R.id.fra_3_edit1);
        fra_3_edit2 = findViewById(R.id.fra_3_edit2);
        ...
        fra_3_text1 = findViewById(R.id.fra_3_text1);
        fra_3_text2 = findViewById(R.id.fra_3_text2);
        ...
        tempError = findViewById(R.id.tempError3);

        button = findViewById(R.id.fra_3_next);
