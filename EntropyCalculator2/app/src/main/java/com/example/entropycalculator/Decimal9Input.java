...
public class Decimal9Input extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_decimal9_input);
    ...
    private void initiateAllElements(){
        de_9_edit1 = findViewById(R.id.de_9_edit1);
        de_9_edit2 = findViewById(R.id.de_9_edit2);
        de_9_edit3 = findViewById(R.id.de_9_edit3);
        de_9_edit4 = findViewById(R.id.de_9_edit4);
        de_9_edit5 = findViewById(R.id.de_9_edit5);
        de_9_edit6 = findViewById(R.id.de_9_edit6);
        de_9_edit7 = findViewById(R.id.de_9_edit7);
        de_9_edit8 = findViewById(R.id.de_9_edit8);
        de_9_edit9 = findViewById(R.id.de_9_edit9);
        //de_10_edit10 = findViewById(R.id.de_10_edit10);

        tempError = findViewById(R.id.de_error9);

        button = findViewById(R.id.de_9_next);
    }

    private void storeAllValues() {

        try{
            a = Double.parseDouble(de_9_edit1.getText().toString());
            b = Double.parseDouble(de_9_edit2.getText().toString());
            c = Double.parseDouble(de_9_edit3.getText().toString());
            d = Double.parseDouble(de_9_edit4.getText().toString());
            e = Double.parseDouble(de_9_edit5.getText().toString());
            f = Double.parseDouble(de_9_edit6.getText().toString());
            g = Double.parseDouble(de_9_edit7.getText().toString());
            h = Double.parseDouble(de_9_edit8.getText().toString());
            i = Double.parseDouble(de_9_edit9.getText().toString());
            ...
            if((a+b+c+d+e+f+g+h+i) == 1.0) {
                intent1 = new Intent(Decimal9Input.this, Display.class);
