...
public class Decimal7Input extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_decimal7_input);
    ...
    private void initiateAllElements(){
        de_7_edit1 = findViewById(R.id.de_7_edit1);
        de_7_edit2 = findViewById(R.id.de_7_edit2);
        de_7_edit3 = findViewById(R.id.de_7_edit3);
        de_7_edit4 = findViewById(R.id.de_7_edit4);
        de_7_edit5 = findViewById(R.id.de_7_edit5);
        de_7_edit6 = findViewById(R.id.de_7_edit6);
        de_7_edit7 = findViewById(R.id.de_7_edit7);
        //de_8_edit8 = findViewById(R.id.de_8_edit8);

        tempError = findViewById(R.id.de_error7);

        button = findViewById(R.id.de_7_next);
    }

    private void storeAllValues() {

        try{
            a = Double.parseDouble(de_7_edit1.getText().toString());
            b = Double.parseDouble(de_7_edit2.getText().toString());
            c = Double.parseDouble(de_7_edit3.getText().toString());
            d = Double.parseDouble(de_7_edit4.getText().toString());
            e = Double.parseDouble(de_7_edit5.getText().toString());
            f = Double.parseDouble(de_7_edit6.getText().toString());
            ...
            calulate();
            if((a+b+c+d+e+f+g) == 1.0) {
                intent1 = new Intent(Decimal7Input.this, Display.class);
